...
# # MLP GenCode 
# Like Wen et al 2018, use GenCode 26.  
# Train on 8K samples per class.  
# Use Wen’s length ranges and K={1,2,3}.  
# Wen's choice of adadelta optimizer and relu activation didn't work for us: learned slowed to glacial speed.  
# MLP used 2x128 sigmoid, adam optimizer; 27,521 parameters.  
# Test on 8K test samples per class.  
# accuracy: 99.98%, AUC: 99.96%
